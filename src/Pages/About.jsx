...
function About() {
	return (
		<>
			{/* First Section */}
			<div>
				<div className="mx-12 md:mx-32 min-h-screen py-32 flex flex-col gap-12 justify-center items-start text-[#004E89]">
					...
					<button className="text-xl px-4 py-2 bg-[#004E89] rounded-lg text-gray-100 font-semibold">
						Connect with us{" "}
					</button>
				</div>
			</div>
			{/* 2nd Section */}
			<div className="bg-[#367EB5]">
				<div className="mx-12 md:mx-32    md:py-32 py-12  flex md:flex-row flex-col gap-12 justify-around items-start">
					<h1 className="text-4xl  font-bold uppercase text-[#fff]">
						Legal aid for kiddos
					</h1>
					<p className="text-lg font-medium text-[#fff] max-w-md mb-2">
			...
			<div className="bg-[#004E89]  ">
				<div className="mx-12 md:mx-32 text-white  py-32 flex flex-col gap-16 md:gap-32 justify-around items-start">
					<div>
						<h1 className="text-4xl font-semibold uppercase  mb-8 md:mb-12">
							NCPCR Resources On Tap
						</h1>
						<main className="flex md:flex-row flex-col md:gap-16 gap-12 ">
					...
					<div className="flex flex-col gap-12">
						...
						<div className="flex gap-4 ">
							<button className="rounded-xl bg-[#FF6B35] text-black px-4 py-2">
								Connect to NCPCR
							</button>
							<button className="rounded-xl bg-gray-100 text-black px-4 py-2">
								Visit NCPCR
							</button>
						</div>
					</div>
