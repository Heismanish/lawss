function Fourth() {
	return (
		<div id="faq" className="my-44 mx-12 md:mx-32">
			<h1 className="font-Jua text-6xl mb-12 md:mb-24 text-[#277da1] font-semibold  ">
				Get your question answered
			</h1>
			<main className="flex gap-12 md:gap-32 flex-col md:flex-row items-center mb-12 md:mb-24">
